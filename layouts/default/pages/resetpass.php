            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-6 col-lg-7">
                        <div class="reset_password_img">
                            <img src="/public/img/undraw_authentication_fsn5.svg" alt="">
                        </div>
                    </div>
                    <div class="col-12 col-sm-12 col-md-6 col-lg-4">
                        <div class="reset">
                           <h3 class="title_reset_pass">Reset password</h3>
                           <div class="printEmpty"></div>
                            <form id="reset">
                                <p><input type="email" name="email" placeholder="Email"></p>
                                <button>Send<span class="loading_content"></span></button>
                            </form>
                        </div>
                    </div>
                </div>
